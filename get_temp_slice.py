...
if len(sys.argv) != 4:
    print "get_temp_slice.py file_name title_name save_name"
    exit()
...
legend.suppliedValues = (0, 12.5, 25, 37.5, 50)
legend.numberFormat = "%0.1f"
legend = GetAnnotationObject(GetPlotList().GetPlots(0).plotName)
