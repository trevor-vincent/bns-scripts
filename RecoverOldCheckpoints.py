...
for group in fh:
  ...
  if name == 'Cp-FuncRegridScaleL.txt' or name == 'Cp-FuncRegridScaleR.txt':
    ...
    outfh.write('Time = %s; ClassID=Exp;CheckpointFileVersion=%s;InitState=%s;NumComponentsQ=%s;Tsaved=  %s;Scalars=  %s,  %s;mRawQ[0][0]= %s;mAvgData[0][0]= %s;mAvgData[1][0]= %s;mAvgData[2][0]=  %s;mIntData[0]= %s;\n' %(tistr,vstr,ISstr,mrsstr,tsstr,s1str,s2str,mrstr,a1str,a2str,a3str,IDstr))
    ...
    for dset in fh[group]:
        ...
        if string == 'RawQ.size':
          mrsstr=fh[group][dset][0]
          mrsstr='2'
    outfh.write('Time=  %s;ClassID=Exp;CheckpointFileVersion=%s;InitState=%s;NumComponentsQ=%s;Tsaved=  %s;Scalars=  %s,  %s;mRawQ[0][0]= %s;mRawQ[0][1]=  %s;mAvgData[0][0]=  %s;mAvgData[0][1]=  %s;mAvgData[1][0]=  %s;mAvgData[1][1]=  %s;mAvgData[2][0]=  %s;mAvgData[2][1]= %s;mIntData[0]=  %s;mIntData[1]=  %s;\n' %(tistr,vstr,Isstr,mrsstr,tsstr,s1str,s2str,mr1str,mr2str,a11str,a12str,a21str,a22str,a31str,a32str,ID1str,ID2str))
    ...
    for dset in fh[group]:
        ...
        if string == 'RawQ.size':
          mrsstr=fh[group][dset][0]
          mrsstr='3'
    outfh.write('Time=  %s;ClassID=Exp;CheckpointFileVersion=%s;InitState=%s;NumComponentsQ=%s;Tsaved=  %s;Scalars=  %s,  %s;mRawQ[0][0]= %s;mRawQ[0][1]=  %s; mRawQ[0][2]=  %s;mAvgData[0][0]=  %s;mAvgData[0][1]=  %s;mAvgData[0][2]=  %s;mAvgData[1][0]=  %s;mAvgData[1][1]=  %s;mAvgData[1][2]=  %s;mAvgData[2][0]=  %s;mAvgData[2][1]= %s;mAvgData[2][2]=  %s;mIntData[0]=  %s;mIntData[1]=  %s;mIntData[2]=  %s;\n' %(tistr,vstr,Isstr,mrsstr,tsstr,s1str,s2str,mr1str,mr2str,mr3str,a11str,a12str,a13str,a21str,a22str,a23str,a31str,a32str,a33str,ID1str,ID2str,ID3str))
    ...
    for dset in fh[group]:
        ...
        if string == 'LastSearchHasFailed':
          lsstr=fh[group][dset][0]
        if string == 'TriggerValueAtLastFailure':
          tvstr=fh[group][dset][0]
    outfh.write('Time=  %s;CheckpointVersion=%s;NumSuccesses=%s;LastSearchHasFailed=%s;TriggerValueAtLastFailure=  %s;\n' %(tistr,vstr,nsstr,lsstr,tvstr))
