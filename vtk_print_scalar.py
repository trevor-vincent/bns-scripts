...
import sys
total = len(sys.argv)
firstdirectory = '/home/tvincent/Dropbox/Research/Notes/BNS-Project/M1_Compare/NEW/ENua0'
seconddirectory = '/home/tvincent/Dropbox/Research/Notes/BNS-Project/M1_Compare/OLD/ENua0'
...
for filename in os.listdir(firstdirectory):
    if filename.endswith("vts"):
        ...
        errdiff(firstfile,secondfile,'ENua')
    else:
        continue
