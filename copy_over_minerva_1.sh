...
function rsync_bns {
    rsync --links -alxuH --progress  --include '*/' --include '*/Run' --include '*Profiler.h5' --include '*.dat' --include '*.txt' --include '*.out' --include '*RhoTempENua/*' --include '*RhoTempENua*' --include '*.input' --exclude '*' --stats $1/ $2/
}
